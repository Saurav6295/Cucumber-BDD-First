...
public class StepDefinitionSimple {
WebDriver driver;
	...
	public void User_is_on_home_page()
	{
		...
		Assert.assertEquals("Online Shopping Site for Mobiles, Electronics, Furniture, Grocery, Lifestyle, Books & More. Best Offers!", title2);
